...
-->
			<div class="form-group">
				<label for="redisEndpoint" class="control-label col-sm-2">Redis Endpoint:</label>
				<div class="col-sm-6"><input class="form-control" type="text" id="redisEndpoint" ng-model="redisEndpoint" placeholder="Database address (hostname or IP)"><span id="mysqlPort" ng-model="mysqlPort"></div>
			</div>
			<div class="form-group">
				<label for="redisPort" class="control-label col-sm-2">Redis Port:</label>
				<div class="col-sm-4"><input class="form-control" type="text" id="redisPort" ng-model="redisPort" placeholder="Database's name">
				</div>
			</div>
			<div class="form-group">
